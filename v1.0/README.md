...
## Incoming release
In He et al., 2020, we tested our MM model on datasets with ICA-fixed and the MM model worked well. We are going to release a new version of MM model which also generalizes well on datasets with GSR.
